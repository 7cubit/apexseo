                ...
                <CardContent className="p-0">
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-sm text-left">
                            ...
                            <tbody>
                                {isLoading ? (
                                    <tr><td colSpan={6} className="text-center py-8 text-gray-400">Loading sites...</td></tr>
                                ) : projects?.length === 0 ? (
                                    <tr><td colSpan={6} className="text-center py-8 text-gray-400">No sites found. Create one to get started.</td></tr>
                                ) : (
