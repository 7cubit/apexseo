...
exports.TruthRiskService = void 0;
const ClickHouseClaimStore_1 = require("../clickhouse/repositories/ClickHouseClaimStore");
class TruthRiskService {
    /**
     ...
     */
    static async calculateTruthRisk(siteId, pageId, content) {
        ...
        for (const claim of claims) {
            await ClickHouseClaimStore_1.ClickHouseClaimStore.saveClaim({
                site_id: siteId,
                page_id: pageId,
                claim_id: claim.id,
...
exports.TruthRiskService = TruthRiskService;
